...
module.exports = {
	// Project options.
	projectURL: "0.0.0.0:8080", // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: "gutenberg-theme", // Your textdomain here.
	translationFile: "gutenberg-theme.pot", // Name of the translation file.
	translationDestination: "./languages", // Where to save the translation files.
	packageName: "GutenbergTheme", // Package name.
